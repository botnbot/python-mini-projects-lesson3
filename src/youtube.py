...
# необходимо установить через: poetry add google-api-python-client
from googleapiclient.discovery import build

import isodate

# YT_API_KEY скопирован из гугла и помещен в переменную
API_KEY: str = "AIzaSyAMpe-6QlikT2WeOmeWlXBS3Gt3sVTuR4A"
